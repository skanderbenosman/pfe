...
public class LSB_encode {
	...
	public void aa(String msg,String f1,String f2) throws Exception {
		
		
int[] bits=bit_Msg(msg);
System.out.println("msg in file "+msg);
for(int i=0;i<bits.length;i++)
System.out.print(bits[i]);
System.out.println();
BufferedImage theImage=readImageFile(f1);
hideTheMessage(bits, theImage,f2);
...
public static void hideTheMessage (int[] bits, BufferedImage theImage,String f2) throws Exception{
	File f = new File (f2);
